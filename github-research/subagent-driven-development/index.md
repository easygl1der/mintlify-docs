...
description: GitHub 仓库深度技术调研 · @anthropics
---
...
flowchart TB
    ...
    subgraph CORE["核心层"]
        ...
        CORE1["Manager Agent"]
        CORE2["Subagent Base"]
        CORE3["Tools Registry"]
        CORE1 -->|"消息通信"| CORE2
        CORE2 -->|"消息通信"| CORE3
        CORE1 <-->|"Message Bus / Event System"| CORE2
        CORE2 <-->|"Message Bus / Event System"| CORE3
    end

    subgraph MODEL["模型层"]
        direction TB
        MODEL1["Claude API (anthropic)"]
    end
